        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-purple-200 mb-4 leading-relaxed">
              Making expense sharing simple and fair. Track, split, and settle expenses with friends and groups effortlessly.
            </p>
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 bg-purple-800 hover:bg-purple-700 rounded-full flex items-center justify-center transition-colors">
        ...
        <div className="pt-8 border-t border-purple-800">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6 text-sm">
              ...
              <a href="#" className="text-purple-300 hover:text-white transition-colors">Accessibility</a>
            </div>
          </div>
        </div>
      </div>
